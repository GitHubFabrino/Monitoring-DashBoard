<template>
  <Transition>
    <div class="cardItem" v-if="show.showAlertBatterie">
      <div
        v-if="show.showAlertBatType === '1'"
        id="alert-border-1"
      ...
      >
        ...
        <button
          type="button"
          @click="show.showAlertBatterie = !show.showAlertBatterie"
