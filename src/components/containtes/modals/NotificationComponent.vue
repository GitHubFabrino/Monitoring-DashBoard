<template>
  <Transition name="sheet" mode="out-in">
    <div
      ...
      v-if="show.showNotificationDetail"
    ...
    >
      <div class="cardItem bg-blue-500" @click.stop>
        <div class="header">
          ...
          <template v-else>
            <div class="cardheader">
              <a
                class="inline-block rounded-full border border-white  text-white hover:bg-[#fb7a58] hover:text-white focus:ring-3 focus:outline-hidden mr-4"
                href="#"
              >
                <i
                  @click="
        ...
        <div class="bodyNotif">
          <template v-if="!show.showNotificationDetailOne">
            <div
              v-if="alerteBatterieStore.alertes.length === 0"
              class="notification"
            >
              <div class="notifItem">
                <svg
            ...
            <div
              ...
              :key="notif.id"
              class="cardNotif hover:bg-[#FB7A58]"
