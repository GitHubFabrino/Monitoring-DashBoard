...
<template>
  <Transition>
    ...
    v-if="show.showDeleteParc" @click="show.showDeleteParc = !show.showDeleteParc">
      <div class="formModal" @click.stop>
        <div class="profilContainer">
          <div class="containerProfil">
            <div class="descriptionProfil">
              <h3>Voulez vous vraiment supprimé {{ show.showParcNameDelete }} ?</h3>
            </div>
          </div>
          <div class="containerBtn">
            <button class="btn fermer" @click="show.showDeleteParc = !show.showDeleteParc">
              Annuller
            </button>
            <button
