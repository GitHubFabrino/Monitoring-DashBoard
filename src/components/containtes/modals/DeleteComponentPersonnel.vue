...
function supprimer() {
  personnel.deleteUser(show.showDeleteIdPersonnel)
}
</script>
...
<template>
  <Transition>
    ...
    v-if="show.showDelete" @click="show.showDelete = !show.showDelete">
      <div class="formModal" @click.stop>
        <div class="profilContainer">
          <div class="containerProfil">
            <div class="descriptionProfil">
              <h3 class="text-[#2d4051] font-nunito">Voulez vous vraiment supprimé {{ show.showDeleteNamePersonnel }} ?</h3>
            </div>
          </div>
          <div class="containerBtn">
            <button class="btn fermer" @click="show.showDelete = !show.showDelete">
              Annuller
            </button>
            <button
