  ...
  <div class="container">
    <div class="titre">
      ...
      <div class="btn" @click="show.showCreationParamBattFunc()">
        <i class="pi pi-plus-circle" style="font-size: 16px; color: #fff"></i>
      </div>
    </div>
    <div class="contenu">
          ...
          <div class="w-full flex items-center flex-wrap justify-center gap-10">
            <div class="grid gap-4 w-60">
              ...
              <div>
                ...
                >
                  Aucune batterie n'est encore configurée
                </h2>
                <p
...
function voirModifier(selectBat) {
  ...
  batterie.nom = selectBat.nom;
  batterie.capaciteNominal = selectBat.capacite_nominal;
  batterie.dateInstallation = new Date(Date.parse(selectBat.date_installation));
  batterie.technologie = selectBat.technologie;
  batterie.marque = selectBat.marque;
  batterie.parcId = selectBat.parcId;
  batterie.parametreBatterieId = selectBat.parametre_batterie_id;
  batterie.description = selectBat.description;
  batterie.tensionNominale = selectBat.tension_nominale;
  batterie.capacite = selectBat.capacite;
  batterie.utilisationVeille = selectBat.utilisation_veille;
  batterie.utilisationCyclique = selectBat.utilisation_cyclique;
  batterie.courant = selectBat.courant;
  batterie.temperature = selectBat.temperature;
  batterie.dodMax = selectBat.dod_max;
