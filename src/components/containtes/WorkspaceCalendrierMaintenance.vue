<template>
  <div class="w-full h-full shadow-sm rounded-sm px-4 py-2 bg-[#f6f8fa]">
    ...
    <div class="contenu">
      ...
      <template v-else>
        <div
          class="bg-white p-2 rounded-lg shadow-lg w-full h-[440px]"
          v-if="showNoDo"
        >
          ...
          <div class="flex justify-between w-full px-4 text-sm">
            <div class="w-[45%]">
              <div class="mb-2">
                <div class="block text-gray-700 font-bold">
                  Date : {{ voirMaintenanceData.maintenance.date_execution }}
                </div>
              </div>
              <div class="mb-2">
            ...
            <div class="w-[45%] flex flex-col justify-center items-center">
              ...
              <div
                @click="doingMaintenance(voirMaintenanceData)"
          ...
          <div class="flex justify-between w-full px-4 text-sm">
            <div class="w-[45%]">
              ...
              <div class="mb-2">
                ...
                <div
                  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight"
                >
                  {{ voirMaintenanceData.maintenance.frequence }}
                </div>
              </div>
              <div class="mb-2">
                <div class="block text-gray-700 font-bold">Batterie :</div>
            ...
            <div class="w-[45%] flex flex-col justify-center items-center">
              <div class="mb-4 w-full">
                ...
                <div
                  class="shadow appearance-none border rounded w-full h-28 py-2 px-3 text-gray-700 leading-tight"
                >
                  {{ voirMaintenanceData.maintenance.travaux_realiser }}
                </div>
              </div>
              <div class="mb-4 w-full">
