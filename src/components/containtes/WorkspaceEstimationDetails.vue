  ...
  >
    ...
    <div>
      <div class="flex justify-around">
        ...
        />
        <div class="w-[70%] flex flex-col items-center p-5">
          <div
            class="max-w-2xl overflow-hidden bg-white shadow sm:rounded-lg h-[350px] w-full"
          >
                    ...
                    >
                      ...
                      <div class="flex items-center px-2 py-1">
                        ...
                        <div class="mx-3">
                          ...
                          >
                            {{
                              show.selectCard.cycle_summary.avg_charge_voltage
                            }}
                          </dd>
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div class="flex items-center px-2 py-1">
                        ...
                        <div class="mx-3">
                          ...
                          >
                            {{
                              show.selectCard.cycle_summary.avg_charge_current
                            }}
                          </dd>
                        </div>
                      </div>
