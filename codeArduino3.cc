...
void setup() {
  ...
  lcd.clear();
  lcd.setCursor(0, 0);
  scrollText("Bienvenu sur Monitoring des Batteries", 0, 300);
  socBat1 = 100; 
  socBat2 = 100;
  socBat3 = 100;
...
//     messageAlerte = "Très bas inférieur à 50% du seuil";


//  // ------------------- Création du message JSON -------------------
//   String message = "{\"idbat\": " + String(batteries[numBatterie][0]) +
//                    ", \"Valert\": " + String(dod, 2) +
//                    ", \"Vseuil\": " + String(batteries[numBatterie][7]) +
//                     ", \"sms\": \"" + messageAlerte + "\"" +
//                      ", \"read\": " + String("0") +
//                    ", \"type\": " + String("dod") +
...
//     messageAlerte = "Bas, inférieur à 75% du seuil ";
...
//     messageAlerte = "DoD proche du seuil (" + String(dod, 2) + "%). ";
...
//     messageAlerte ="Température élevée (" + String(temperature, 2) + "°C), supérieure au maximum autorisé (" + String(batteries[numBatterie][4], 2) + "°C). ";
  
//      // ------------------- Création du message JSON -------------------
//   String message = "{\"idbat\": " + String(batteries[numBatterie][0]) +
//                    ", \"Valert\": " + String(temperature, 2) +
//                    ", \"Vseuil\": " + String(batteries[numBatterie][7]) +
//                     ", \"sms\": \"" + messageAlerte + "\"" +
//                      ", \"read\": " + String("0") +
...
//     gravite = max(gravite, 3); // Gravité élevée
//     messageAlerte = "Température élevée (" + String(temperature, 2) + "°C), proche du seuil (" + String(batteries[numBatterie][4], 2) + "°C). ";
//         // ------------------- Création du message JSON -------------------
//   String message = "{\"idbat\": " + String(batteries[numBatterie][0]) +
//                    ", \"Valert\": " + String(temperature, 2) +
//                    ", \"Vseuil\": " + String(batteries[numBatterie][7]) +
...
//     gravite = max(gravite, 4); // Gravité critique
//     messageAlerte = "Courant élevé (" + String(courant, 2) + "A), supérieur au maximum autorisé (" + String(batteries[numBatterie][2], 2) + "A). ";
//   String message = "{\"idbat\": " + String(batteries[numBatterie][0]) +
//                    ", \"Valert\": " + String(courant, 2) +
//                    ", \"Vseuil\": " + String(batteries[numBatterie][7]) +
//                     ", \"sms\": \"" + messageAlerte + "\"" +
//                      ", \"read\": " + String("0") +
//                    ", \"type\": " + String("courant") +
...
//     gravite = max(gravite, 3); // Gravité élevée
//     messageAlerte += "Courant faible (" + String(courant, 2) + "A), inférieur au minimum autorisé (" + String(batteries[numBatterie][3], 2) + "A). ";
...
//     gravite = max(gravite, 4); // Gravité critique
//     messageAlerte = "Tension élevée (" + String(tension, 2) + "V), supérieure au maximum autorisé (" + String(batteries[numBatterie][5], 2) + "V). ";



//     String message = "{\"idbat\": " + String(batteries[numBatterie][0]) +
//                    ", \"Valert\": " + String(tension, 2) +
//                    ", \"Vseuil\": " + String(batteries[numBatterie][7]) +
//                     ", \"sms\": \"" + messageAlerte + "\"" +
//                      ", \"read\": " + String("0") +
//                    ", \"type\": " + String("tension") +
...
// === Fonction pour créer et envoyer des messages JSON ===
...
void verifierDoD(int numBatterie, float dod, int &gravite) {
  if (dod < batteries[numBatterie][7] * 0.5) {
    gravite = 4;
...
void verifierTemperature(int numBatterie, float temperature, int &gravite) {
  if (temperature > batteries[numBatterie][4]) {
...
void verifierCourant(int numBatterie, float courant, int &gravite) {
  if (courant > batteries[numBatterie][2]) {
    gravite = max(gravite, 4);
...
// === Fonction principale ===
void verifierAlerteBatterie(int numBatterie, float dod, float temperature, int relaisBatterie, float courant, float tension, float soc) {
  int gravite = 1; // Gravité par défaut

  verifierDoD(numBatterie, dod, gravite);
  verifierTemperature(numBatterie, temperature, gravite);
  verifierCourant(numBatterie, courant, gravite);

  // Vous pouvez ajouter d'autres vérifications ici (par ex. tension).
}
...
void afficherSurMoniteurSerie() {
  ...
  for (int i = 0; i < nombreBatteriesConnectees; i++) {
    ...
    Serial.print(i + 1);
    Serial.print(": ");
    Serial.print(tensions[i], 4);
    Serial.print("V, ");
    Serial.print(courants[i], 4);
    Serial.print("A, ");
